...
public class Subset {
  public static void main(String[] args) {
    ...
    // System.out.println(    findSubSetsWithoutDuplicates(new ArrayList<>(), arr, 0, arr.length-1));
  ...
  // We have seen recursive approach how can we do this in iterative approach first we will look into without duplicates then we can proceed with duplicates 
